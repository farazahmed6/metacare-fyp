    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Meta Care, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          Meta Care is designed to simplify healthcare access. You can choose a
          specialist, schedule an appointment, and engage in a virtual
      ...
      <div className="legal-footer">
        <p>© 2024-2028 Meta. All rights reserved.</p>
      </div>
    </div>
  );
}
